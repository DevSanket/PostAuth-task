import { View, Text,StyleSheet,Animated,FlatList,ActivityIndicator,TouchableOpacity } from 'react-native'
...
export default function Home({navigation}:HomeScreenProps) {
  ...
  return (
    <View style={styles.container}>
        <ActivityIndicator size="large" animating={loading} style={{position:"absolute",zIndex:2,top:"50%",left:"45%"}} />
        <Animated.View
          style={{
           ...
           <TouchableOpacity style={{flexDirection:"row",gap:5,alignItems:'center'}} onPress={() => navigation.navigate("Login")}>
